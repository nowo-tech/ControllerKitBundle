...
1. [CHANGELOG.md](CHANGELOG.md) — version **1.0.1** and date set; `[Unreleased]` empty.
2. [UPGRADING.md](UPGRADING.md) — upgrade notes for **1.0.1** (same-host Referer behavior).
3. [USAGE.md](USAGE.md) / [SECURITY.md](SECURITY.md) — aligned with Referer host validation.
4. `make release-check` — cs-fix, cs-check, rector-dry, phpstan, test-coverage, demo release-check.
5. Commit: `Release v1.0.1`
6. Annotated tag: `git tag -a v1.0.1 -m "Release v1.0.1"`
